...
public class  SignUtils {
     ...
     * @return
     */
    public static void buildPayParamsSign(StringBuilder sb,Map<String, String> payParams,boolean encoding){
    ...
    public static void buildPayParams(StringBuilder sb,Map<String, String> payParams,boolean encoding){
        ...
        for(String key : keys){
            ...
            if(encoding){
                ...
                try {
                    sb.append(new String(payParams.get(key).getBytes(), "ISO8859-1"));
