...
import com.mock.pay.pf.PFWechatMicropayService;
...
@Service
public class PFWechatMicropayServiceImpl implements PFWechatMicropayService {

    private static final Logger logger = LoggerFactory.getLogger(PFWechatMicropayServiceImpl.class);
...
private String privateKey= KeyString.privateKey;
    ...
    public void payResp(Map<String, String> map,PrintWriter out) throws IOException {
        ...
        String autoCode=map.get("autoCode");//授权字符串
        String code=autoCode.substring(0,7);
