...
import com.mock.pay.pf.PFWechatWapService;
...
@Service
public class PFWechatWapServiceImpl implements PFWechatWapService{

    private static final Logger logger = LoggerFactory.getLogger(PFWechatWapServiceImpl.class);
...
//            redisCache.put(out_trade_no, tmpString);
        ...
        if("0000".equals(respCode)){
            ...
            String payInfo="https://wx.tenpay.com/cgi-bin/mmpayweb-bin/checkmweb?prepay_id=wx20170914115508d2f8787f450203143687&package="+StringUtil.getCode(10,0);
            respMap.put("payInfo", Base64.encode(payInfo.getBytes()));//唤起微信Wap支付的参数
        }else {
