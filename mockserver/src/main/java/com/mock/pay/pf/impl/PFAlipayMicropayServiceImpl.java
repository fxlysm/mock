...
import com.mock.pay.pf.PFAlipayMicropayService;
...
@Service
public class PFAlipayMicropayServiceImpl implements PFAlipayMicropayService{
    private static final Logger logger = LoggerFactory.getLogger(PFAlipayMicropayServiceImpl.class);
    String PFMOCK= SystemConf.PFMOCK_MSG;

    @Resource
    private RedisTemplate<String, Object> redisTemplate;

    @Value("${pf.alipay.micropay.rate}")
    private double rate;
