...
import com.mock.pay.pf.PFWechatScanService;
...
@Service
public class PFWechatScanServiceImpl implements PFWechatScanService{

    private static final Logger logger = LoggerFactory.getLogger(PFWechatScanServiceImpl.class);
...
//            redisCache.put(out_trade_no, tmpString);
        ...
        if("0000".equals(respCode)){
            String url= "weixin://wxpay/bizpayurl?"+ map.get(productId) + StringUtil.getRandomString(8);
